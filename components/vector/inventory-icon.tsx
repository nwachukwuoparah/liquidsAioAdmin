...
export function InventoryIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        d="M3.75 10.9053V16.8748H16.25V10.9053"
        stroke="currentColor"
        strokeWidth={1.5}
        strokeLinecap="round"
      ...
      />
      <path
        d="M4.21875 3.125H15.7812C15.917 3.12503 16.0491 3.16926 16.1575 3.25101C16.2659 3.33277 16.3447 3.44759 16.382 3.57812L17.5 7.5H2.5L3.62031 3.57812C3.65754 3.44798 3.73601 3.33343 3.84393 3.25172C3.95185 3.17 4.08338 3.12553 4.21875 3.125Z"
        stroke="currentColor"
        strokeWidth={1.5}
        strokeLinecap="round"
        strokeLinejoin="round"
